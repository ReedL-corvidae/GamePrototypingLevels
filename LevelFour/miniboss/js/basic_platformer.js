...
var win = false;
	...
	platform1 = new GameObject();
		platform1.width = 200;
		platform1.x = canvas.width/2 - 50;
		platform1.y = canvas.height - platform0.height/2;
		platform1.color = "#66ff33";
	
	platform2 = new GameObject();
		platform2.width = 300;
		platform2.x = canvas.width - 120;
		platform2.y = canvas.height - 550;
...
function animate()
{
	...
	if(platform1.y + 50 > canvas.height - 10)
	{
		platform1.y++;
		platform1.vy--;	
	}

	if(platform1.y < platform1.height/2 + 100){
		platform1.y++;
		platform1.vy++;
	}
